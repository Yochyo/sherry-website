  ...
  return (
    <Transition.Root show={props.open} as={Fragment}>
      <Dialog as="div" className="fixed inset-0 z-10 overflow-y-auto" onClose={props.setOpen}>
        <div className="flex min-h-screen items-start justify-center px-4 text-center sm:block sm:p-0" onClick={() => props.setOpen(false)}>
          {/* background */}
          ...
          <Transition.Child
            ...
            <div className="relative inline-block h-screen min-w-full p-8">
